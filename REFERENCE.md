...
[WIP: To link each section to the respective train]
...
참고로 카트리지 슬롯 머신에선 ![막대사탕](./media/icons/lollipop.png) 막대사탕, ![어려움](./media/icons/nether.png) 어려움, ![긴맵](./media/icons/marathon.png) 긴맵 카트리지는 출현하지 않습니다.
...
바이옴 교차로는 각 바이옴의 보스를 쓰러트리고 도착하는 역으로, 다음 바이옴으로 전진하기 전 잠시 정비할 수 있는 역입니다.
...
오른편에는 플레이어가 전진할 수 있는 새로운 바이옴 2개가 출현합니다. 바이옴을 선택하면 기차 속도가 초기 상태로 초기화됩니다. (첫번째 루프 한정)
...
다음 바이옴으로 전진하는 경우, 항상 상점 역이 첫번째 역으로 출현합니다.
