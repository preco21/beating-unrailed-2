...
![곡괭이 이미지](./media/tools/pickaxe.png)
...
![양동이 이미지](./media/tools/bucket.png)
...
우유가 담긴 양동이를 든 플레이어 본인이 우유를 마시려면 양동이를 바닥에 내려놓고 상호작용 키를 눌러야 합니다. 이 때 양동이는 다시 손에 들리지 않습니다.
